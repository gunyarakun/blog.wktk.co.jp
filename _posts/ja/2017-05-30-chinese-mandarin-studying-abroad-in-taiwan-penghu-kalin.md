...
台湾は現金があったほうがいいです。両替レートは台湾のほうが有利なので、日本で両替せずに、日本円を台湾まで持ってきて、空港の両替所で両替してください。
...
あとは、お茶などのペットボトルの大きいのを買って、水筒に入れて、飲食店に行ったりしていた。お茶は基本糖分入りなので、日式と書いてあったりする無糖のものを選んで買ってた。
...
問い合わせも日本語OKだし、中国語0、英語0でも生きていけます。

あとは、中華電信のSIMカードあって助かった。空港限定で、安い値段でデータ使い放題のプランを提供している。中華電信はdocomoみたいなイメージで、地方でもエリアが広いらしい。桃園・松山両空港にカウンターあります。ただし、安いデータ使い放題のカードは、追加入金で延長はできない。最大30日のプランしかないので、それを越える滞在の場合には別プランか、もしくはiTaiwanのWi-Fiを観光カウンターで登録して、SIMは慣れない滞在初期専用と割り切るのもいいかも。宿からの車での送り迎えがあるので、最終日インターネットなくても大丈夫だし。

泊まるとき持っていったほうがいいもの。重要度順。
